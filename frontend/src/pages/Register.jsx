    ...
    <div className='h-screen flex justify-center items-center'>
        <div className=' p-10 w-1/3 h-auto shadow-2xl ' >
            ...
            <form action="" className='mb-8'>
                ...
                <label htmlFor="" className='flex flex-col'>
                Password
                <input type="password" placeholder='Password' className='border border-gray-400 p-1 rounded-sm placeholder:text-slate-200 focus:ring-2 ring-blue-500 outline-none' {...register('Password')} />
                </label>
                </div>
                <div className='mb-4'>
